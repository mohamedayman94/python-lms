"""
Django settings for pyls project.
...
SECRET_KEY = 'django-insecure-jrogx4fkl83m^h)l(d8m*(2=je9p$-pj!1*6=uv2l__rcv^(^q'
...
WSGI_APPLICATION = 'pyls.wsgi.application'
